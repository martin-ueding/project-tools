...
def main():
	...
	ignorepatterns = []
	try:
		with open(os.path.expanduser("~/.config/nocopyrightfinder/ignore.txt")) as ifile:
			for line in ifile:
	...
	copypatterns = []
	try:
		with open(os.path.expanduser("~/.config/nocopyrightfinder/patterns.txt")) as patternfile:
